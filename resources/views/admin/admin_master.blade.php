...
<html lang="en" dir="ltr">
  ...
  <link rel="stylesheet" href="style.css" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.css">
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      ...
                      <span class="d-none d-lg-inline-block">{{substr(Auth::user()->name,0,-9)}}</span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-right">
                      <!-- User image -->
                      <li class="dropdown-header">
                        ...
                        <div class="d-inline-block">
                          {{substr(Auth::user()->name,0,-9)}} <small class="pt-1">{{Auth::user()->email}}</small>
                        </div>
                      </li>
